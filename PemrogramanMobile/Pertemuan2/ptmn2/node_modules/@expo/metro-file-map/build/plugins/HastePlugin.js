...
const _sorting = require("../lib/sorting");
const _DuplicateHasteCandidatesError = require("./haste/DuplicateHasteCandidatesError");
const _HasteConflictsError = require("./haste/HasteConflictsError");
const _getPlatformExtension = /*#__PURE__*/ _interop_require_default(require("./haste/getPlatformExtension"));
...
class HastePlugin {
    ...
    async initialize({ files }) {
        ...
        for (const { baseName, canonicalPath, pluginData: hasteId } of files.fileIterator({
            ...
            this.setModule(hasteId, [
                canonicalPath,
                this.#enableHastePackages && baseName === 'package.json' ? _constants.default.PACKAGE : _constants.default.MODULE
            ]);
        ...
        this.#getModuleNameByPath = (mixedPath)=>{
            ...
            return result.exists && result.type === 'f' && typeof result.pluginData === 'string' ? result.pluginData : null;
        };
    ...
    getModule(name, platform, supportsNativePlatform, type) {
        ...
        if (module && module[_constants.default.TYPE] === (type ?? _constants.default.MODULE)) {
   ...
   */ #getModuleMetadata(name, platform, supportsNativePlatform) {
        ...
        if (supportsNativePlatform) {
            this.#assertNoDuplicates(name, _constants.default.NATIVE_PLATFORM, supportsNativePlatform, dupMap.get(_constants.default.NATIVE_PLATFORM));
            if (map[_constants.default.NATIVE_PLATFORM]) {
                return map[_constants.default.NATIVE_PLATFORM];
            }
        }
        this.#assertNoDuplicates(name, _constants.default.GENERIC_PLATFORM, supportsNativePlatform, dupMap.get(_constants.default.GENERIC_PLATFORM));
    ...
    #assertNoDuplicates(name, platform, supportsNativePlatform, relativePathSet) {
        ...
        throw new _DuplicateHasteCandidatesError.DuplicateHasteCandidatesError(name, platform, supportsNativePlatform, duplicates);
    }
    onChanged(delta) {
    ...
    #onNewFile(canonicalPath, id) {
        ...
        const module = [
            canonicalPath,
            this.#enableHastePackages && _path().default.basename(canonicalPath) === 'package.json' ? _constants.default.PACKAGE : _constants.default.MODULE
        ];
    ...
    setModule(id, module) {
        ...
        const platform = (0, _getPlatformExtension.default)(module[_constants.default.PATH], this.#platforms) || _constants.default.GENERIC_PLATFORM;
        ...
        if (existingModule && existingModule[_constants.default.PATH] !== module[_constants.default.PATH]) {
            if (this.#console) {
                this.#console.warn([
                    ...
                    '    * <rootDir>' + _path().default.sep + existingModule[_constants.default.PATH],
                    '    * <rootDir>' + _path().default.sep + module[_constants.default.PATH],
                    ''
                ].join('\n'));
            }
    ...
    #onRemovedFile(canonicalPath, moduleName) {
        ...
        const platform = (0, _getPlatformExtension.default)(canonicalPath, this.#platforms) || _constants.default.GENERIC_PLATFORM;
   ...
   */ #recoverDuplicates(moduleName, relativeFilePath) {
        ...
        const platform = (0, _getPlatformExtension.default)(relativeFilePath, this.#platforms) || _constants.default.GENERIC_PLATFORM;
    ...
    computeConflicts() {
        ...
        for (const [id, dupsByPlatform] of this.#duplicates.entries()){
            for (const [platform, conflictingModules] of dupsByPlatform){
                conflicts.push({
                    absolutePaths: [
                        ...conflictingModules.keys()
                    ].map((modulePath)=>this.#pathUtils.normalToAbsolute(modulePath))// Sort for ease of testing
                    .sort(),
                    id,
                    platform: platform === _constants.default.GENERIC_PLATFORM ? null : platform,
                    type: 'duplicate'
                });
            }
        }
        ...
        for (const [id, data] of this.#map){
            ...
            for (const basePlatform of [
                ...
                for (const platform of Object.keys(data)){
                    if (platform === basePlatform || platform === _constants.default.GENERIC_PLATFORM /* lowest priority */ ) {
                        continue;
                    }
        ...
        conflicts.sort((0, _sorting.chainComparators)((a, b)=>(0, _sorting.compareStrings)(a.type, b.type), (a, b)=>(0, _sorting.compareStrings)(a.id, b.id), (a, b)=>(0, _sorting.compareStrings)(a.platform, b.platform)));
        return conflicts;
    }
    getCacheKey() {
...
//# sourceMappingURL=HastePlugin.js.map
