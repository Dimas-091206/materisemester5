...
Object.defineProperty(exports, "FileSystemChangeAggregator", {
    enumerable: true,
    get: function() {
        return FileSystemChangeAggregator;
    }
});
class FileSystemChangeAggregator {
    ...
    getSize() {
        return this.#addedDirectories.size + this.#removedDirectories.size + this.#addedFiles.size + this.#modifiedFiles.size + this.#removedFiles.size;
    }
    getView() {
        return {
...
//# sourceMappingURL=FileSystemChangeAggregator.js.map
