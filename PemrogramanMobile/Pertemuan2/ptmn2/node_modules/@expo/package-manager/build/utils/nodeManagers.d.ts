...
export type NodePackageManager = NpmPackageManager | PnpmPackageManager | YarnPackageManager | BunPackageManager | NubPackageManager;
...
export declare const NUB_LOCK_FILE = "nub.lock";
