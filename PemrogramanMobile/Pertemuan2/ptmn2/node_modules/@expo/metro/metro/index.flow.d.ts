...
export interface _RunServerOptions_websocketEndpoints {
  readonly [path: string]: WebSocketServer;
}
export interface RunServerOptions {
  ...
  readonly secureServerOptions?: HttpsServerOptions;
...
export interface _RunBuildOptions_output {
  readonly build: (server: MetroServer, requestOptions: RequestOptions, buildOptions?: BuildOptions) => Promise<{
    code: string;
    map: string;
  ...
  readonly save: (output: {
    code: string;
    map: string;
  }, opts: OutputOptions, logger: (logMessage: string) => void) => Promise<unknown>;
}
...
type DependenciesCommandOptions = {
  readonly [$$Key$$: string]: unknown;
} | null;
export { Terminal, JsonReporter, TerminalReporter };
export type { AssetData } from "./Assets";
export type { AsyncDependencyType, DeltaResult, Dependency, MixedOutput, Module, ReadOnlyDependencies, ReadOnlyGraph, SerializerOptions, TransformInputOptions, TransformResult, TransformResultDependency } from "./DeltaBundler/types";
