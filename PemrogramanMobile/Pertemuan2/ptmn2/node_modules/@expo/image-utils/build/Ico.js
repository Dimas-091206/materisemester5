...
Object.defineProperty(exports, "generateAsync", {
    enumerable: true,
    get: function() {
...
async function generateAsync(buffers) {
    const pngs = await Promise.all(buffers.map((x)=>(0, _parsepng().default)(x)));
