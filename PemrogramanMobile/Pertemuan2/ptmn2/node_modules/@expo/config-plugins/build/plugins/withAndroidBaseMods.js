...
0 && (module.exports = {
    getAndroidModFileProviders: null,
    sortAndroidManifest: null,
    withAndroidBaseMods: null
});
...
_export(exports, {
    get getAndroidModFileProviders () {
        return getAndroidModFileProviders;
    },
    get sortAndroidManifest () {
        return sortAndroidManifest;
    },
    get withAndroidBaseMods () {
        return withAndroidBaseMods;
    }
});
function _fs() {
...
const _android = require("../android");
const _XML = require("../utils/XML");
const _sortObject = require("../utils/sortObject");
const _createBaseMod = require("./createBaseMod");
