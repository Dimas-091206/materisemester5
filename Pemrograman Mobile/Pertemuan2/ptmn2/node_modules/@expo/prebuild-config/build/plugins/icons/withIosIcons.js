...
0 && (module.exports = {
    generateUniversalIconAsync: null,
    getIcons: null,
    setIconsAsync: null,
    withIosIcons: null
});
...
_export(exports, {
    get generateUniversalIconAsync () {
        return generateUniversalIconAsync;
    },
    get getIcons () {
        return getIcons;
    },
...
const _AssetContents = require("./AssetContents");
function _interop_require_default(obj) {
    return obj && obj.__esModule ? obj : {
        default: obj
    };
}
const { getProjectName, unquote } = _configplugins().IOSConfig.XcodeUtils;
const IMAGE_CACHE_NAME = 'icons';
const IMAGESET_PATH = 'Images.xcassets/AppIcon.appiconset';
const DEFAULT_APPICON_NAME = 'AppIcon';
const withIosIcons = (config)=>{
    config = (0, _configplugins().withDangerousMod)(config, [
        'ios',
        async (config)=>{
...
function getIcons(config) {
    ...
    if (iosSpecificIcons) {
        ...
        if (typeof iosSpecificIcons === 'object') {
            const paths = [
                iosSpecificIcons.light,
                iosSpecificIcons.dark,
                iosSpecificIcons.tinted
            ].filter(Boolean);
...
async function generateUniversalIconAsync(projectRoot, { icon, cacheKey, iosNamedProjectRoot, platform, appearance }) {
    const size = 1024;
