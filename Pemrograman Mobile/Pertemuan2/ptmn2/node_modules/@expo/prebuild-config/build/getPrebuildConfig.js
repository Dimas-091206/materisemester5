...
const _withDefaultPlugins = require("./plugins/withDefaultPlugins");
...
function getPrebuildConfig(projectRoot, { platforms, bundleIdentifier, packageName, autolinkedModules }) {
    ...
    let { exp: config, ...rest } = (0, _config().getConfig)(projectRoot, {
