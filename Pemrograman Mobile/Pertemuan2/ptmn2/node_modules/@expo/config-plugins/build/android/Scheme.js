...
0 && (module.exports = {
    appendScheme: null,
    ensureManifestHasValidIntentFilter: null,
    getScheme: null,
    getSchemesFromManifest: null,
    hasScheme: null,
    removeScheme: null,
    setScheme: null,
    withScheme: null
...
_export(exports, {
    ...
    get ensureManifestHasValidIntentFilter () {
        return ensureManifestHasValidIntentFilter;
    },
    get getScheme () {
        return getScheme;
    },
    get getSchemesFromManifest () {
        return getSchemesFromManifest;
    },
    get hasScheme () {
        return hasScheme;
    },
