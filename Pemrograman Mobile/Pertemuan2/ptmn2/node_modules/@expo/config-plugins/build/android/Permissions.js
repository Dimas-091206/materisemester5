...
0 && (module.exports = {
    addBlockedPermissions: null,
    addPermission: null,
    addPermissionToManifest: null,
    ensurePermission: null,
    ensurePermissionNameFormat: null,
    ensurePermissions: null,
    getAndroidPermissions: null,
    getPermissions: null,
    isPermissionAlreadyRequested: null,
    removePermissions: null,
    setAndroidPermissions: null,
    withBlockedPermissions: null,
    withInternalBlockedPermissions: null,
...
_export(exports, {
    get addBlockedPermissions () {
        return addBlockedPermissions;
    },
    get addPermission () {
        return addPermission;
    },
    get addPermissionToManifest () {
        return addPermissionToManifest;
    },
    get ensurePermission () {
        return ensurePermission;
    },
    get ensurePermissionNameFormat () {
        return ensurePermissionNameFormat;
    },
    get ensurePermissions () {
        return ensurePermissions;
    },
    get getAndroidPermissions () {
        return getAndroidPermissions;
    },
    get getPermissions () {
        return getPermissions;
    },
    get isPermissionAlreadyRequested () {
        return isPermissionAlreadyRequested;
    },
    get removePermissions () {
        return removePermissions;
    },
    get setAndroidPermissions () {
        return setAndroidPermissions;
    },
    get withBlockedPermissions () {
        return withBlockedPermissions;
    },
    get withInternalBlockedPermissions () {
        return withInternalBlockedPermissions;
    },
    get withPermissions () {
...
const withBlockedPermissions = (config, permissions)=>{
    const resolvedPermissions = prefixAndroidPermissionsIfNecessary((Array.isArray(permissions) ? permissions : [
        permissions
    ]).filter(Boolean));
