...
import { Appearance, StatusBar as NativeStatusBar, useColorScheme } from 'react-native';
/**
 ...
 */ export function StatusBar({ style, hideTransitionAnimation, animated, hidden }) {
    ...
    const barStyle = React.useMemo(()=>styleToBarStyle(style, colorScheme ?? undefined), [
        style,
        colorScheme
    ]);
    return /*#__PURE__*/ _jsx(NativeStatusBar, {
        animated: animated,
        hidden: hidden,
        barStyle: barStyle,
 ...
 * ```
 */ StatusBar.setStyle = (style, animated)=>NativeStatusBar.setBarStyle(styleToBarStyle(style), animated);
/**
 ...
 * ```
 */ StatusBar.setHidden = (hidden, animation)=>NativeStatusBar.setHidden(hidden, animation);
/**
...
//# sourceMappingURL=NativeStatusBarWrapper.js.map
