...
exports.unstable_createBundleCommandParser = unstable_createBundleCommandParser;
...
function unstable_createBundleCommandParser(additionalOptions = []) {
  const parser = new _commander.Command()
