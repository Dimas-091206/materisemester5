...
function attachKeyHandlers({ devServerUrl, messageSocket, reporter }) {
  ...
  _nodeReadline.default.emitKeypressEvents(process.stdin);
  setRawMode(true);
  ...
  ${(0, _nodeUtil.styleText)(["bold", "inverse"], " r ")} - reload app(s)
  ${(0, _nodeUtil.styleText)(["bold", "inverse"], " d ")} - open Dev Menu
  ${(0, _nodeUtil.styleText)(["bold", "inverse"], " j ")} - open DevTools
`,
  });
}
function setRawMode(enable) {
  (0, _invariant.default)(
    process.stdin instanceof _nodeTty.ReadStream,
