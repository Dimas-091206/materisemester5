...
Object.defineProperty(exports, "checkDependencyWebAsync", {
    enumerable: true,
    get: function() {
        return checkDependencyWebAsync;
    }
});
...
async function checkDependencyWebAsync(resolution, reactNativeConfig, expoModuleConfig) {
    ...
    if (!hasReactNativeConfig) {
        const packageJson = await (0, _utils.loadPackageJson)((0, _utils.fastJoin)(resolution.path, 'package.json'));
        if (!packageJson) {
            return null;
        }
