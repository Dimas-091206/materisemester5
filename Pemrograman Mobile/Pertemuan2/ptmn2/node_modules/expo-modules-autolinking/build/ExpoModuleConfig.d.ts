...
export declare class ExpoAndroidProjectConfig {
     ...
     */
    isDefault: boolean;
    constructor(name: string, path: string, modules?: ExpoAndroidModuleConfig[] | undefined, modulesV2?: string[] | undefined, services?: string[] | undefined, publication?: AndroidPublication | undefined, gradleAarProjects?: AndroidGradleAarProjectDescriptor[] | undefined, shouldUsePublicationScriptPath?: string | undefined, 
    /**
     * Whether this project is the root one.
     */
    isDefault?: boolean);
