...
withBackgroundColor:(NSNumber *)withBackgroundColor
  withDismissButton:(NSNumber *)withDismissButton;
- (void)hide;
...
- (void)promiseThrows:(RCTPromiseResolveBlock)resolve
               reject:(RCTPromiseRejectBlock)reject;
- (void)voidFuncAssert;
- (NSDictionary *)getObjectAssert:(NSDictionary *)arg;
- (void)promiseAssert:(RCTPromiseResolveBlock)resolve
               reject:(RCTPromiseRejectBlock)reject;
- (void)getImageUrl:(RCTPromiseResolveBlock)resolve
             reject:(RCTPromiseRejectBlock)reject;
...
inline NSString *JS::NativeAccessibilityManager::SpecAnnounceForAccessibilityWithOptionsOptions::priority() const
{
  id const p = _v[@"priority"];
...
inline NSString *JS::NativeWebSocketModule::SpecConnectOptions::unstable_devToolsRequestId() const
{
  id const p = _v[@"unstable_devToolsRequestId"];
  return RCTBridgingToOptionalString(p);
}
