...
namespace facebook::react {
    ...
    static facebook::jsi::Value __hostFunction_NativeDevLoadingViewSpecJSI_showMessage(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, VoidKind, "showMessage", @selector(showMessage:withColor:withBackgroundColor:withDismissButton:), args, count);
    }
  ...
  NativeDevLoadingViewSpecJSI::NativeDevLoadingViewSpecJSI(const ObjCTurboModule::InitParams &params)
    : ObjCTurboModule(params) {
        ...
        methodMap_["showMessage"] = MethodMetadata {4, __hostFunction_NativeDevLoadingViewSpecJSI_showMessage};
...
- (void)emitOnPress
{
  ...
  if (eventEmitterCallback) {
    eventEmitterCallback("onPress", nil);
  }
}
- (void)emitOnClick:(NSString *_Nonnull)value
{
  auto eventEmitterCallback = _eventEmitterCallback;
  if (eventEmitterCallback) {
    eventEmitterCallback("onClick", value);
  }
}
- (void)emitOnChange:(NSDictionary *)value
{
  auto eventEmitterCallback = _eventEmitterCallback;
  if (eventEmitterCallback) {
    eventEmitterCallback("onChange", value);
  }
}
- (void)emitOnSubmit:(NSArray<id<NSObject>> *)value
{
  auto eventEmitterCallback = _eventEmitterCallback;
  if (eventEmitterCallback) {
    eventEmitterCallback("onSubmit", value);
  }
}
...
namespace facebook::react {
    ...
    static facebook::jsi::Value __hostFunction_NativeSampleTurboModuleSpecJSI_getEnum(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, NumberKind, "getEnum", @selector(getEnum:), args, count);
    }
    ...
    static facebook::jsi::Value __hostFunction_NativeSampleTurboModuleSpecJSI_getUnsafeObject(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, ObjectKind, "getUnsafeObject", @selector(getUnsafeObject:), args, count);
    }
    ...
    static facebook::jsi::Value __hostFunction_NativeSampleTurboModuleSpecJSI_createNativeBuffer(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, ArrayBufferKind, "createNativeBuffer", @selector(createNativeBuffer:), args, count);
    }

    static facebook::jsi::Value __hostFunction_NativeSampleTurboModuleSpecJSI_processAsyncBuffer(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, PromiseKind, "processAsyncBuffer", @selector(processAsyncBuffer:resolve:reject:), args, count);
    }
    ...
    static facebook::jsi::Value __hostFunction_NativeSampleTurboModuleSpecJSI_voidFuncThrows(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, VoidKind, "voidFuncThrows", @selector(voidFuncThrows), args, count);
    }

    static facebook::jsi::Value __hostFunction_NativeSampleTurboModuleSpecJSI_getObjectThrows(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, ObjectKind, "getObjectThrows", @selector(getObjectThrows:), args, count);
    }

    static facebook::jsi::Value __hostFunction_NativeSampleTurboModuleSpecJSI_promiseThrows(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, PromiseKind, "promiseThrows", @selector(promiseThrows:reject:), args, count);
    }

    static facebook::jsi::Value __hostFunction_NativeSampleTurboModuleSpecJSI_voidFuncAssert(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, VoidKind, "voidFuncAssert", @selector(voidFuncAssert), args, count);
    }

    static facebook::jsi::Value __hostFunction_NativeSampleTurboModuleSpecJSI_getObjectAssert(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, ObjectKind, "getObjectAssert", @selector(getObjectAssert:), args, count);
    }

    static facebook::jsi::Value __hostFunction_NativeSampleTurboModuleSpecJSI_promiseAssert(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, PromiseKind, "promiseAssert", @selector(promiseAssert:reject:), args, count);
    }

    static facebook::jsi::Value __hostFunction_NativeSampleTurboModuleSpecJSI_getImageUrl(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, PromiseKind, "getImageUrl", @selector(getImageUrl:reject:), args, count);
    }
  ...
  NativeSampleTurboModuleSpecJSI::NativeSampleTurboModuleSpecJSI(const ObjCTurboModule::InitParams &params)
    : ObjCTurboModule(params) {
        ...
        methodMap_["getArrayBuffer"] = MethodMetadata {1, __hostFunction_NativeSampleTurboModuleSpecJSI_getArrayBuffer};
        
        
        methodMap_["createNativeBuffer"] = MethodMetadata {1, __hostFunction_NativeSampleTurboModuleSpecJSI_createNativeBuffer};
        
        
        methodMap_["processAsyncBuffer"] = MethodMetadata {1, __hostFunction_NativeSampleTurboModuleSpecJSI_processAsyncBuffer};
