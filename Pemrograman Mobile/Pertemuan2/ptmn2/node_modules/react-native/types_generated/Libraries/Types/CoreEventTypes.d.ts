 ...
 *
 * @generated SignedSource<<13de8ece57efc993ce7b819255ce1ed6>>
 *
...
export type ResponderSyntheticEvent<T> = Readonly<Omit<NativeSyntheticEvent<T>, "touchHistory"> & {
...
export type TextLayoutLine = Readonly<Omit<LayoutRectangle, "ascender" | "capHeight" | "descender" | "text" | "xHeight"> & {
  ascender: number;
  capHeight: number;
  descender: number;
  text: string;
