 ...
 *
 * @generated SignedSource<<43b1ef0294572b6615f8177c1fa2fe72>>
 *
...
type TextInputSelectionChangeEventData = Readonly<Omit<TargetEvent, "selection"> & {
  selection: Selection;
}>;
/**
...
type TextInputKeyPressEventData = Readonly<Omit<TargetEvent, "key" | "target" | "eventCount"> & {
  key: string;
...
type TextInputEndEditingEventData = Readonly<Omit<TargetEvent, "eventCount" | "text"> & {
  eventCount: number;
  text: string;
}>;
/**
...
type TextInputSubmitEditingEventData = Readonly<Omit<TargetEvent, "eventCount" | "text"> & {
  eventCount: number;
  text: string;
}>;
/**
 ...
 *
 */
type InternalTextInput = (props: Omit<TextInputProps, "ref"> & {
