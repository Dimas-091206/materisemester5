...
class StatusError extends Error {
    ...
    constructor(status = 500, body, errorOptions){
        const cause = (errorOptions != null && errorOptions.cause) ?? (body != null && typeof body === 'object' && body.cause != null ? body.cause : undefined);
        ...
        if (body instanceof Error) {
            ...
            this.body = typeof body === 'object' ? JSON.stringify(body, null, 2) : body ?? JSON.stringify({
                error: message
            }, null, 2);
        }
    }
...
function errorToResponse(error) {
    if (error instanceof StatusError) {
        ...
        const body = 'body' in error && typeof error.body === 'string' ? error.body : JSON.stringify({
            error: error.message
        }, null, 2);
