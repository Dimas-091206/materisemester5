...
Object.defineProperty(exports, "createRequestScope", {
    enumerable: true,
    get: function() {
        return createRequestScope;
    }
});
const _importMetaRegistry = require("../utils/importMetaRegistry");
    ...
    try {
        Object.defineProperty(globalThis, 'origin', {
            ...
            get () {
                ...
                return _scope.scopeRef.current?.getStore()?.origin ?? 'null';
            }
        });
    } catch  {}
    try {
        Object.defineProperty(globalThis, '__ExpoImportMetaRegistry', {
            ...
            configurable: true,
            get () {
                return _importMetaRegistry.importMetaRegistry;
            }
        });
    } catch  {}
}
function createRequestScope(scopeDefinition, makeRequestAPISetup) {
    ...
    return async (run, ...args)=>{
        ...
        _scope.scopeRef.current = scopeDefinition;
        ...
        let result;
        try {
            result = _scope.scopeRef.current != null ? await _scope.scopeRef.current.run(scope, ()=>run(...args)) : await run(...args);
        } catch (error) {
            if (error != null && error instanceof Response && !error.bodyUsed) {
                result = error;
            } else if (error != null && error instanceof Error && 'status' in error) {
                return (0, _error.errorToResponse)(error);
            } else {
                throw error;
            }
        }
