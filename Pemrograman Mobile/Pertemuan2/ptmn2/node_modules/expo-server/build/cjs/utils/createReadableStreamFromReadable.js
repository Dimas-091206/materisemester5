...
Object.defineProperty(exports, "createReadableStreamFromReadable", {
    enumerable: true,
    get: function() {
...
class StreamPump {
    ...
    controller;
    constructor(stream){
        this.highWaterMark = stream.readableHighWaterMark || new (_nodestream()).Stream.Readable().readableHighWaterMark;
