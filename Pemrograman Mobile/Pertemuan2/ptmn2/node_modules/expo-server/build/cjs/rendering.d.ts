...
export type SsrRenderFn = (request: Request, options?: RenderOptions) => Promise<string | ReadableStream<Uint8Array>>;
...
export declare function isStreamingRenderer(module: LegacyServerRenderModule | ServerRenderModule): module is ServerRenderModule;
