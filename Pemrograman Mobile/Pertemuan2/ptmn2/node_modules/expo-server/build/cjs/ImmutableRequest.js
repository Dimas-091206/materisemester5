...
0 && (module.exports = {
    ImmutableHeaders: null,
    ImmutableRequest: null,
    assertRuntimeFetchAPISupport: null
});
...
_export(exports, {
    get ImmutableHeaders () {
        return ImmutableHeaders;
    },
    get ImmutableRequest () {
        return ImmutableRequest;
    },
    get assertRuntimeFetchAPISupport () {
        return assertRuntimeFetchAPISupport;
    }
});
/**
 ...
 */ const getHeadersConstructor = ()=>{
    if (typeof Headers !== 'undefined') {
        ...
        return globalThis.Headers ?? class _MockHeaders {
            constructor(){
...
class ImmutableRequest {
    ...
    /** The request body is not accessible in immutable requests. */ get body() {
...
function assertRuntimeFetchAPISupport({ Request, Response, Headers: Headers1, process } = globalThis) {
    // Check if Request and Response are available.
    if (typeof Request === 'undefined' || typeof Response === 'undefined' || typeof Headers1 === 'undefined') {
