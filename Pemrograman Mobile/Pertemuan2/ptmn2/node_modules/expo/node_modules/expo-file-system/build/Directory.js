 ...
 */ export class Directory extends ExpoFileSystem.FileSystemDirectory {
   ...
   */ list() {
        return super.listAsRecords().map(({ isDirectory, uri })=>isDirectory ? new Directory(uri) : new File(uri));
    }
    /**
   * Directory name.
   */ get name() {
   ...
   */ watch(callback, options) {
        return new FileSystemWatcher(this.uri, callback, options, (uri, isDirectory)=>isDirectory ? new Directory(uri) : new File(uri));
    }
}
