...
Object.defineProperty(exports, "createDocumentMetadataInjectionTransform", {
    enumerable: true,
    get: function() {
        return createDocumentMetadataInjectionTransform;
    }
});
...
function createDocumentMetadataInjectionTransform(options) {
    let buffer = '';
    let injected = false;
    ...
    return new TransformStream({
        transform (chunk, controller) {
            ...
            if (hasRequiredDocumentPrefix) {
                const bodyOpenTagEndIdx = options.bodyAttributes ? buffer.indexOf('>', bodyOpenIdx) : headCloseIdx + HEAD_CLOSE_TAG.length;
