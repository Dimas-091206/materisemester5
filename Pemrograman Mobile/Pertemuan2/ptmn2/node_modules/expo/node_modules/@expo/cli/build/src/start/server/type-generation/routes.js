...
0 && (module.exports = {
    ARRAY_GROUP_REGEX: null,
    CAPTURE_DYNAMIC_PARAMS: null,
    CAPTURE_GROUP_REGEX: null,
    CATCH_ALL: null,
    SLUG: null,
    TYPED_ROUTES_EXCLUSION_REGEX: null,
    extrapolateGroupRoutes: null,
    getTemplateString: null,
    getTypedRoutesUtils: null,
    setToUnionType: null,
    setupTypedRoutes: null
});
...
_export(exports, {
    get ARRAY_GROUP_REGEX () {
        return ARRAY_GROUP_REGEX;
    },
    get CAPTURE_DYNAMIC_PARAMS () {
        return CAPTURE_DYNAMIC_PARAMS;
    },
    get CAPTURE_GROUP_REGEX () {
        return CAPTURE_GROUP_REGEX;
    },
    get CATCH_ALL () {
        return CATCH_ALL;
    },
    ...
    get TYPED_ROUTES_EXCLUSION_REGEX () {
        return TYPED_ROUTES_EXCLUSION_REGEX;
    },
    get extrapolateGroupRoutes () {
        return extrapolateGroupRoutes;
    },
    get getTemplateString () {
        return getTemplateString;
    },
    get getTypedRoutesUtils () {
        return getTypedRoutesUtils;
    },
    get setToUnionType () {
        return setToUnionType;
    },
    get setupTypedRoutes () {
        return setupTypedRoutes;
    }
});
function _path() {
   ...
   */ const dynamicRoutes = new Map();
    ...
    const addFilePath = (filePath)=>{
        ...
        const dynamicParams = new Set([
            ...route.matchAll(CAPTURE_DYNAMIC_PARAMS)
        ].map((match)=>match[1]));
