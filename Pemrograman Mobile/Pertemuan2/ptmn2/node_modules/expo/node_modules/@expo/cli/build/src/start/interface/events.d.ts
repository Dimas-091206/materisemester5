...
declare module '2g' {
    interface EventRegistry {
        ...
        'cli-interface:run-menu-action': {
            action: string;
        };
        'cli-interface:send-dev-command': {
            commandName: string;
        };
        'cli-interface:banners-failed': {
            error: SerializedError;
        };
        'cli-interface:action-failed': {
            error: SerializedError;
        };
    }
}
export declare const event: import("2g").EventLogger<"cli-interface">;
