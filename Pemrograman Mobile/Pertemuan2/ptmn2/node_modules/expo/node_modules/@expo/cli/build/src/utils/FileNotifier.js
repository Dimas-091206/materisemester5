...
class FileNotifier {
    ...
    startObserving(callback) {
        ...
        if (configPath) {
            (0, _events.event)('file_observing', {
                path: _events.event.path(configPath)
            });
    ...
    /** Watch the file and warn to reload the CLI if it changes. */ watchFile = (0, _fn.memoize)(this.startWatchingFile.bind(this));
