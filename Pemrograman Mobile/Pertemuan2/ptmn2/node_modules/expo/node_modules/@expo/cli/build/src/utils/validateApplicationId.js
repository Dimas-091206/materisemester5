...
0 && (module.exports = {
    assertValidBundleId: null,
    assertValidPackage: null,
    getBundleIdWarningAsync: null,
    getBundleIdWarningInternalAsync: null,
    getPackageNameWarningAsync: null,
    getPackageNameWarningInternalAsync: null,
    getSanitizedBundleIdentifier: null,
    getSanitizedPackage: null,
    validateBundleId: null,
    validatePackage: null,
    validatePackageWithWarning: null
});
...
async function getBundleIdWarningInternalAsync(bundleId) {
    ...
    if (!await (0, _url.isUrlAvailableAsync)('itunes.apple.com')) {
        (0, _events.event)('bundle_id_no_network', {
            bundleId
        });
    ...
    try {
        (0, _events.event)('bundle_id_checking', {
            bundleId,
            url
        });
        ...
        (0, _events.event)('bundle_id_check_error', {
            bundleId,
...
async function getPackageNameWarningInternalAsync(packageName) {
    ...
    if (!await (0, _url.isUrlAvailableAsync)('play.google.com')) {
        (0, _events.event)('package_name_no_network', {
            packageName
        });
        // If no network, simply skip the warnings since they'll just lead to more confusion.
        return null;
    ...
    try {
        (0, _events.event)('package_name_checking', {
            packageName,
            url
        });
        const response = await fetch(url);
        ...
        (0, _events.event)('package_name_check_error', {
            packageName,
            error: _events.event.error(error)
        });
    }
