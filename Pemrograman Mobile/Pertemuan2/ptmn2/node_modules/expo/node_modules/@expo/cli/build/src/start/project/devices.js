...
0 && (module.exports = {
    DevicesFile: null,
    getDevicesInfoAsync: null,
    readDevicesInfoAsync: null,
    saveDevicesAsync: null,
    setDevicesInfoAsync: null
});
...
_export(exports, {
    ...
    get getDevicesInfoAsync () {
        return getDevicesInfoAsync;
    },
    get readDevicesInfoAsync () {
        return readDevicesInfoAsync;
    },
    get saveDevicesAsync () {
        return saveDevicesAsync;
    },
    get setDevicesInfoAsync () {
        return setDevicesInfoAsync;
    }
});
const _events = require("../server/events");
...
async function saveDevicesAsync(projectRoot, deviceIds) {
    ...
    (0, _events.debugEvent)('devices_saved', {
        ids: newDeviceIds
    });
