...
function importFromExpoWebpackConfig(projectRoot, folder, moduleId) {
    try {
        ...
        (0, _events.event)('webpack_template_resolved', {
            moduleId,
            path: filePath
        });
        return filePath;
    } catch  {
        (0, _events.event)('webpack_template_fallback', {
            moduleId
        });
    }
...
function importFromVendor(projectRoot, moduleId) {
    try {
        ...
        (0, _events.event)('cli_template_resolved', {
            moduleId,
            path: filePath
        });
        return filePath;
        ...
        (0, _events.event)('cli_template_fallback', {
            moduleId,
            path: filePath
        });
        return filePath;
