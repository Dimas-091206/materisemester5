...
0 && (module.exports = {
    ExpoGoManifestHandlerMiddleware: null,
...
_export(exports, {
    get ExpoGoManifestHandlerMiddleware () {
...
const _resolveForwarded = require("./resolveForwarded");
...
const event = (0, _2g().events)('manifest');
let multipartMixedContentType = _multitars().multipartContentType;
if (multipartMixedContentType.startsWith(MULTIPART_TYPE)) {
    multipartMixedContentType = 'multipart/mixed' + multipartMixedContentType.slice(MULTIPART_TYPE.length);
}
...
class ExpoGoManifestHandlerMiddleware extends _ManifestMiddleware.ManifestMiddleware {
    getParsedHeaders(req) {
        ...
        if (!platform) {
            (0, _events.manifestDebugEvent)('no_platform_header', {});
            platform = 'ios';
        }
        ...
        const forwarded = (0, _resolveForwarded.parseForwardedRequestInfo)(req);
        return {
            responseContentType,
            platform,
            ...
            case 0:
                {
                    ...
                    return new Response(stringifiedManifest, {
                        status: 200,
                        headers
                    });
                }
    ...
    encodeFormDataAsync({ stringifiedManifest, manifestPartHeaders, certificateChainBody }) {
        ...
        return new Response((0, _multitars().iterableToStream)((0, _multitars().streamMultipart)(parts)), {
            status: 200,
            headers
        });
    }
