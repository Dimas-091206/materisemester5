...
0 && (module.exports = {
    MAX_PACKAGES_PER_QUERY: null,
    checkPackagesCompatibility: null
});
...
async function checkPackagesCompatibility(packages) {
    try {
        ...
        const incompatiblePackages = packagesToCheck.filter((packageName)=>packageMetadata[packageName]?.newArchitecture === 'unsupported');
