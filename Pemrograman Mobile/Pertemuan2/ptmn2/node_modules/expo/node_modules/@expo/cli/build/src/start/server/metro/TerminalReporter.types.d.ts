...
export interface TerminalReporterInterface {
     ...
     */
    _getBundleStatusMessage({ bundleDetails: { entryFile, bundleType, runtimeBytecodeVersion }, transformedFileCount, totalFileCount, ratio, }: BundleProgress, phase: BuildPhase): string;
     ...
     */
    _updateBundleProgress({ buildID, transformedFileCount, totalFileCount, }: BundleProgressUpdate): void;
    /**
