...
0 && (module.exports = {
    AFCError: null,
    AFCProtocolClient: null,
    AFCProtocolReader: null,
    AFCProtocolWriter: null,
    AFC_FILE_OPEN_FLAGS: null,
    AFC_HEADER_SIZE: null,
    AFC_MAGIC: null,
    AFC_OPS: null,
    AFC_STATUS: null
});
...
_export(exports, {
    ...
    get AFCProtocolClient () {
        return AFCProtocolClient;
    },
    get AFCProtocolReader () {
        return AFCProtocolReader;
    },
    get AFCProtocolWriter () {
        return AFCProtocolWriter;
    },
    get AFC_FILE_OPEN_FLAGS () {
    ...
    constructor(socket){
        ...
        const reader = this.readerFactory.create((resp, err)=>{
            if (err && err instanceof AFCInternalError) {
                ...
                this.requestCallbacks[resp.id]?.(resp, new AFCError(AFC_STATUS?.[resp.data] ?? 'UNKNOWN_ERROR', resp.data));
            } else {
