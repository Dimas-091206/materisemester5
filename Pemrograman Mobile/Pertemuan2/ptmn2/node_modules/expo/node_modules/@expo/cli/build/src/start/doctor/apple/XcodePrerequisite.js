...
0 && (module.exports = {
    XcodePrerequisite: null,
    getXcodeVersionAsync: null
});
...
_export(exports, {
    get XcodePrerequisite () {
        return XcodePrerequisite;
    },
    get getXcodeVersionAsync () {
...
const getXcodeVersionAsync = async ({ silent, force } = {})=>{
    const logError = silent ? (_msg)=>{} : _log.warn;
...
class XcodePrerequisite extends _Prerequisite.Prerequisite {
   ...
   */ async assertImplementation() {
        ...
        (0, _events.debugEvent)('xcode_version', {
            version
        });
        if (!version) {
            ...
            if (getXcodeInstalled()) {
                ...
                (0, _events.debugEvent)('xcode_select_path', {
                    path: selectPath
                });
                if (!selectPath) {
                    _log.error([
                    ...
                    (0, _events.debugEvent)('xcode_setup_unexpected', {
                        version,
                        path: selectPath
                    });
                }
