...
function coercePlatformToOsType(platform) {
    ...
    switch(platform){
        ...
        case 'xrOS':
            return 'xrOS';
        default:
            (0, _events.debugEvent)('apple_device:unknown_platform', {
                platform
            });
            return platform;
    }
...
function coerceUsbmuxdPlatformToOsType(platform) {
    ...
    switch(platform){
        ...
        case 'iPhone OS':
            return 'iOS';
        default:
            (0, _events.debugEvent)('apple_device:unknown_usbmuxd_platform', {
                platform
            });
            return platform;
    }
...
async function runOnDevice({ udid, appPath, bundleId, waitForApp, deltaPath, onProgress }) {
    (0, _events.debugEvent)('apple_device:run_started', {
        udid,
        bundleId
    });
    ...
    try {
        ...
        if (appInfo) {
            ...
            if (waitForApp && debugServerClient) {
                ...
                (0, _events.debugEvent)('apple_device:wait_app', {});
    ...
    while(tries < 3){
        ...
        if (result === 'OK') {
            if (detach) {
                ...
                (0, _events.debugEvent)('apple_device:disconnect_response', {
                    result: res
                });
                if (res !== 'OK') {
            ...
            (0, _events.debugEvent)('apple_device:launch_retry', {
                tries
            });
            tries++;
 ...
 */ async function launchApp(clientManager, { bundleId, appInfo, detach }) {
    try {
        ...
        (0, _events.debugEvent)('apple_device:launch_fallback', {
