...
0 && (module.exports = {
    resolveBuildCache: null,
    resolveBuildCacheProvider: null,
    resolvePluginFunction: null,
    uploadBuildCache: null
});
...
_export(exports, {
    get resolveBuildCache () {
        return resolveBuildCache;
    },
    get resolveBuildCacheProvider () {
        return resolveBuildCacheProvider;
    },
    get resolvePluginFunction () {
        return resolvePluginFunction;
    },
    get uploadBuildCache () {
...
const _events = require("../../run/events");
...
async function uploadBuildCache({ projectRoot, platform, provider, buildPath, runOptions }) {
    ...
    if (!fingerprintHash) {
        (0, _events.debugEvent)('build_cache:no_fingerprint', {});
        return;
    }
...
async function manuallyLoadDependency(projectRoot, packageName) {
    ...
    const { main } = await import(_path().default.join(nodeModulesFolder, packageName, 'package.json'));
    return import(_path().default.join(nodeModulesFolder, packageName, main));
}
