...
0 && (module.exports = {
    addDomBundleToMetadataAsync: null,
    exportDomComponentAsync: null,
    transformDomEntryForMd5Filename: null,
    transformNativeBundleForMd5Filename: null
});
...
_export(exports, {
    get addDomBundleToMetadataAsync () {
        return addDomBundleToMetadataAsync;
    },
    get exportDomComponentAsync () {
        return exportDomComponentAsync;
    },
    get transformDomEntryForMd5Filename () {
        return transformDomEntryForMd5Filename;
    },
    get transformNativeBundleForMd5Filename () {
...
async function exportDomComponentAsync({ filePath, projectRoot, dev, devServer, isHermes, includeSourceMaps, exp, files, useMd5Filename = false }) {
    ...
    (0, _events.debugEvent)('dom:bundle', {
        filePath
    });
    ...
    const generatedEntryPath = _path().default.resolve(filePath.startsWith('file://') ? _url().default.fileURLToPath(filePath) : filePath);
