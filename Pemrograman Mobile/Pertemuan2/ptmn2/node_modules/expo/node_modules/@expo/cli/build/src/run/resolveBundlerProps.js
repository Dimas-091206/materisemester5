...
Object.defineProperty(exports, "resolveBundlerPropsAsync", {
    enumerable: true,
    get: function() {
        return resolveBundlerPropsAsync;
    }
});
...
async function resolveBundlerPropsAsync(projectRoot, options) {
    ...
    let port = options.bundler ? await (0, _port.resolveMetroPortAsync)(projectRoot, {
    ...
    if (!port) {
        ...
        port = (0, _port.isValidPort)(options.port) ? options.port : 8081;
    }
