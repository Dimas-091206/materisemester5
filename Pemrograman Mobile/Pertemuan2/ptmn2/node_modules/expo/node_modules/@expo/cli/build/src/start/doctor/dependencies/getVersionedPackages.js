...
0 && (module.exports = {
    getCombinedKnownVersionsAsync: null,
    getOperationLog: null,
    getRemoteVersionsForSdkAsync: null,
    getVersionedPackagesAsync: null
});
...
_export(exports, {
    get getCombinedKnownVersionsAsync () {
        return getCombinedKnownVersionsAsync;
    },
    get getOperationLog () {
        return getOperationLog;
    },
    get getRemoteVersionsForSdkAsync () {
        return getRemoteVersionsForSdkAsync;
    },
    get getVersionedPackagesAsync () {
...
async function getRemoteVersionsForSdkAsync({ sdkVersion, skipCache } = {}) {
    ...
    try {
        ...
        if (!sdkVersion || !(sdkVersion in sdkVersions)) {
            (0, _events.debugEvent)('sdk_version_not_found', {
                sdkVersion,
