...
export type MetadataTwitterImage = ArrayElement<NonNullable<NonNullable<Metadata['twitter']>['images']>>;
export type MetadataTwitterPlayer = ArrayElement<NonNullable<NonNullable<Metadata['twitter']>['players']>>;
