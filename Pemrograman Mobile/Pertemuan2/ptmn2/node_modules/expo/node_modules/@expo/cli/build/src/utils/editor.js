...
0 && (module.exports = {
    guessEditor: null,
    guessFallbackVisualEditor: null,
    openInEditorAsync: null
});
    ...
    if (editor && !editor.isTerminalEditor) {
        ...
        if (editor) {
            try {
                ...
                (0, _events.event)('editor_open_failed', {
                    file: fileReference,
