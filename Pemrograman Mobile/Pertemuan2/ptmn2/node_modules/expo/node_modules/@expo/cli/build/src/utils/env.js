...
class Env {
    ...
    /** Higher priority `$EDITOR` variable for indicating which editor to use when pressing `o` in the Terminal UI. */ get EXPO_EDITOR() {
        return (0, _getenv().string)('EXPO_EDITOR', '');
    }
    /** Overwrite the hostname used in dev server URLs, disregarding the `--host`, `--lan` and `--localhost` arguments. */ get REACT_NATIVE_PACKAGER_HOSTNAME() {
        return (0, _getenv().string)('REACT_NATIVE_PACKAGER_HOSTNAME', '')?.trim() || null;
    }
    /**
   ...
   */ get EXPO_OVERRIDE_METRO_CONFIG() {
        ...
        return (0, _env().getOriginalEnvValue)('EXPO_OVERRIDE_METRO_CONFIG')?.trim() || undefined;
    }
    /**
