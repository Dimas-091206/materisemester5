...
Object.defineProperty(exports, "renderRsc", {
    enumerable: true,
    get: function() {
        return renderRsc;
    }
...
function _rsc() {
    const data = require("expo-router/internal/rsc");
    _rsc = function() {
        return data;
    };
    return data;
...
function _server() {
    const data = require("react-server-dom-webpack/server");
    _server = function() {
        return data;
    };
    return data;
...
async function renderRsc(args, opts) {
    ...
    const { default: { renderEntries }, // @ts-expect-error
    buildConfig } = entries;
    function resolveRequest(isServer, encodedId) {
        const [// File is the on-disk location of the module, this is injected during the "use client" transformation (babel).
        file, // The name of the import (e.g. "default" or "")
    ...
    const renderWithContext = async (context, input, params)=>{
        ...
        return (0, _server1.runWithRenderStore)(renderStore, async ()=>{
            ...
            return (0, _server().renderToReadableStream)(elements, bundlerConfig, {
                onError
            });
        });
    };
    const renderWithContextWithAction = async (context, actionFn, actionArgs)=>{
        ...
        return (0, _server1.runWithRenderStore)(renderStore, async ()=>{
            ...
            return (0, _server().renderToReadableStream)({
                ...elements,
                _value: actionValue
            }, bundlerConfig, {
                onError
    ...
    if (body) {
        ...
        if (typeof contentType === 'string' && contentType.startsWith('multipart/form-data')) {
            ...
            decodedBody = await (0, _server().decodeReply)(formData, serverConfig);
        } else if (bodyStr) {
            decodedBody = await (0, _server().decodeReply)(bodyStr, serverConfig);
        }
    }
    const actionId = (0, _rsc().decodeActionId)(input);
