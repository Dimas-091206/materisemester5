...
0 && (module.exports = {
    copyTemplateFiles: null,
    createCopyFilesSuccessMessage: null
});
...
_export(exports, {
    get copyTemplateFiles () {
        return copyTemplateFiles;
    },
    get createCopyFilesSuccessMessage () {
...
function copyTemplateFiles(projectRoot, { templateDirectory, platforms }) {
    ...
    (0, _events.debugEvent)('gitignore_check', {
        allPlatformsHaveGitignore: hasPlatformSpecificGitIgnores
    });
