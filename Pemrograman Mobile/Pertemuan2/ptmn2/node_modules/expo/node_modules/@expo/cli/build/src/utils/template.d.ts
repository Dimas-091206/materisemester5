 ...
 */
export declare function unsafeTemplate(strings: TemplateStringsArray, ...keys: (string | number)[]): (...values: (string | number)[] | [...(string | number)[], Record<string | number, string>]) => string;
