...
0 && (module.exports = {
    decodeFilePathFromAbsolute: null,
    encodeFilePathToAbsolute: null,
    extname: null,
    filePathToFileURL: null,
...
_export(exports, {
    get decodeFilePathFromAbsolute () {
        return decodeFilePathFromAbsolute;
    },
    get encodeFilePathToAbsolute () {
        return encodeFilePathToAbsolute;
    },
    get extname () {
        return extname;
    },
    get filePathToFileURL () {
...
const fileURLToFilePath = (fileURL)=>{
    ...
    return ABSOLUTE_WIN32_PATH_REGEXP.test(filePath) ? filePath.slice(1).replace(/\//g, '\\') : filePath;
};
