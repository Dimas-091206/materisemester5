...
0 && (module.exports = {
    getApiRoutesForDirectory: null,
    getAppRouterRelativeEntryPath: null,
    getMiddlewareForDirectory: null,
    getRoutePaths: null,
    getRouterDirectory: null,
    getRouterDirectoryModuleIdWithManifest: null,
    hasWarnedAboutApiRoutes: null,
    hasWarnedAboutMiddleware: null,
    isApiRouteConvention: null,
    warnInvalidMiddlewareMatcherSettings: null,
    warnInvalidMiddlewareOutput: null,
    warnInvalidWebOutput: null
});
...
_export(exports, {
    get getApiRoutesForDirectory () {
        return getApiRoutesForDirectory;
    },
    get getAppRouterRelativeEntryPath () {
        return getAppRouterRelativeEntryPath;
    },
    get getMiddlewareForDirectory () {
    ...
    get getRouterDirectoryModuleIdWithManifest () {
        return getRouterDirectoryModuleIdWithManifest;
    },
    get hasWarnedAboutApiRoutes () {
        return hasWarnedAboutApiRoutes;
    },
    get hasWarnedAboutMiddleware () {
        return hasWarnedAboutMiddleware;
    },
    get isApiRouteConvention () {
        return isApiRouteConvention;
    },
    get warnInvalidMiddlewareMatcherSettings () {
        return warnInvalidMiddlewareMatcherSettings;
    },
    get warnInvalidMiddlewareOutput () {
        return warnInvalidMiddlewareOutput;
    },
    get warnInvalidWebOutput () {
...
const _routerEvents = require("./routerEvents");
...
function getAppRouterRelativeEntryPath(projectRoot, routerDirectory = getRouterDirectory(projectRoot)) {
    ...
    (0, _routerEvents.event)('entry_resolved', {
        routerEntry: _routerEvents.event.path(routerEntry),
        appFolder: _routerEvents.event.path(appFolder),
        appRoot
    });
    return appRoot;
}
...
function getMiddlewareForDirectory(cwd, mode) {
