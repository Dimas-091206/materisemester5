...
0 && (module.exports = {
    convertPathToModuleSpecifier: null,
    createBundleOsPath: null,
    createBundleUrlPath: null,
    createBundleUrlPathFromExpoConfig: null,
    createBundleUrlSearchParams: null,
    getAsyncRoutesFromExpoConfig: null,
    getBaseUrlFromExpoConfig: null,
    getMetroDirectBundleOptions: null,
    getMetroDirectBundleOptionsForExpoConfig: null,
    getMetroOptionsFromUrl: null,
    isServerEnvironment: null
});
...
const _metroDebugEvents = require("../metro/metroDebugEvents");
...
function getMetroDirectBundleOptions(options) {
    ...
    if (isExporting) {
        (0, _metroDebugEvents.debugEvent)('options_lazy_disabled_for_export', {});
        options.lazy = false;
    }
    let fakeSourceUrl;
