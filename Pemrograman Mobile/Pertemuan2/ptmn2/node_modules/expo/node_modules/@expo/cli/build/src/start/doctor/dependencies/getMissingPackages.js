...
0 && (module.exports = {
    collectMissingPackages: null,
    getMissingPackagesAsync: null,
    mutatePackagesWithKnownVersionsAsync: null,
    versionSatisfiesRequiredPackage: null
});
...
_export(exports, {
    get collectMissingPackages () {
        return collectMissingPackages;
    },
    get getMissingPackagesAsync () {
        return getMissingPackagesAsync;
    },
    get mutatePackagesWithKnownVersionsAsync () {
        return mutatePackagesWithKnownVersionsAsync;
    },
    get versionSatisfiesRequiredPackage () {
...
function versionSatisfiesRequiredPackage(packageJsonFilePath, resolvedPackage) {
    ...
    (0, _events.debugEvent)('dependency_version_mismatch', {
...
async function getMissingPackagesAsync(projectRoot, { sdkVersion, requiredPackages }) {
    ...
    (0, _events.event)('dependencies:missing', {
        packages: results.missing.map((pkg)=>pkg.pkg)
    });
