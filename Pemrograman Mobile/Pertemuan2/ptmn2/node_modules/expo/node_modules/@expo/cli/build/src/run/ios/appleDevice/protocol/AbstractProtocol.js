...
0 && (module.exports = {
    PlistProtocolReader: null,
    ProtocolClient: null,
    ProtocolClientError: null,
    ProtocolReader: null,
    ProtocolReaderFactory: null
});
...
_export(exports, {
    get PlistProtocolReader () {
        return PlistProtocolReader;
    },
    get ProtocolClient () {
        return ProtocolClient;
    },
    get ProtocolClientError () {
        return ProtocolClientError;
    },
    get ProtocolReader () {
        return ProtocolReader;
    },
    get ProtocolReaderFactory () {
...
class ProtocolClientError extends _errors.CommandError {
    ...
    constructor(msg, error, protocolMessage){
        super(msg), this.error = error, this.protocolMessage = protocolMessage;
    }
}
