        ...
        if (method === 'POST') {
            ...
            try {
                ...
                sendError(res, 500, {
                    ...
                    details: (typeof error?.message === 'string' ? error.message : String(error)) + ` Check the dev server logs for more detail, or use GET /_expo/open?platform=${platform} to launch the deep link from another environment.`
                });
            }
            return;
        }
