...
0 && (module.exports = {
    assertPlatforms: null,
    ensureValidPlatforms: null,
    resolvePackageManagerOptions: null,
    resolvePlatformOption: null,
    resolveSkipDependencyUpdate: null,
    resolveTemplateOption: null
});
...
function resolveTemplateOption(template) {
    ...
    if (template.startsWith('https://') || template.startsWith('http://')) {
        ...
        (0, _events.debugEvent)('template_option_repository', {
            uri: template
        });
        return {
            type: 'repository',
    ...
    template.startsWith(_path().default.sep)) {
        ...
        (0, _events.debugEvent)('template_option_file', {
            path: _events.debugEvent.path(templatePath)
        });
        return {
            type: 'file',
            uri: templatePath
    ...
    (0, _events.debugEvent)('template_option_npm', {
        name: template
    });
    return {
        type: 'npm',
