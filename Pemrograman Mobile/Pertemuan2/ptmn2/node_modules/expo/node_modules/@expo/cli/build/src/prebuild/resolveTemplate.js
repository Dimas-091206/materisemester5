...
async function cloneTemplateAsync({ templateDirectory, projectRoot, template, exp, ora }) {
    if (template) {
        ...
        if (type === 'file') {
            (0, _events.event)('template:resolved', {
                source: 'local',
                name: uri
            });
        ...
        try {
            const result = await (0, _resolveLocalTemplate.resolveLocalTemplateAsync)({
                templateDirectory,
                projectRoot,
                exp
            });
            ...
            (0, _events.debugEvent)('sdk_template_fallback', {
...
async function downloadAndExtractRepoAsync({ username, name, branch, filePath }, output, props) {
    ...
    (0, _events.debugEvent)('repo_tarball_download', {
        url
    });
