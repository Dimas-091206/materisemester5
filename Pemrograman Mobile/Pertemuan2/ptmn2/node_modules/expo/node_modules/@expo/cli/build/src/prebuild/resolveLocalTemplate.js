...
async function resolveLocalTemplateAsync({ templateDirectory, projectRoot, exp }) {
    ...
    if (monorepoTemplatePath) {
        (0, _events.debugEvent)('local_template_packing', {
            path: _events.debugEvent.path(monorepoTemplatePath)
        });
        try {
            templatePath = await (0, _npm.packNpmTarballAsync)(monorepoTemplatePath);
            (0, _events.debugEvent)('local_template_packed', {
        ...
        (0, _events.debugEvent)('local_template_fallback', {
            path: _events.debugEvent.path(templatePath)
        });
    }
