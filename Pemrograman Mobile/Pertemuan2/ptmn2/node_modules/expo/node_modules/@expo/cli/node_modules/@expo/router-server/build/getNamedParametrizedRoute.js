...
0 && (module.exports = {
    getNamedParametrizedRoute: null,
    parseParameter: null
});
...
_export(exports, {
    get getNamedParametrizedRoute () {
        return getNamedParametrizedRoute;
    },
    get parseParameter () {
...
function getNamedParametrizedRoute(route) {
    ...
    const namedParameterizedRoute = segments.map((segment, index)=>{
        ...
        if (/^\[.*\]$/.test(segment)) {
            ...
            const groupName = (0, _routing().matchGroupName)(segment).split(',').map((group)=>group.trim()).filter(Boolean);
