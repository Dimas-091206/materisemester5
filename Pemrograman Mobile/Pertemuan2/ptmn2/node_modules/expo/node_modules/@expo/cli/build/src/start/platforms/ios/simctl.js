...
0 && (module.exports = {
    bootAsync: null,
    bootDeviceAsync: null,
    getBootedSimulatorsAsync: null,
    getContainerPathAsync: null,
    getDevicesAsync: null,
    getInfoPlistValueAsync: null,
    installAsync: null,
    isDeviceBootedAsync: null,
    isOSType: null,
    openAppIdAsync: null,
    openUrlAsync: null,
    simctlAsync: null,
...
/** Rewrite the simulator permissions to allow opening deep links without needing to prompt the user first. */ async function updateSimulatorLinkingPermissionsAsync(device, { url, appId }) {
    if (!device.udid || !appId) {
        (0, _events.event)('simctl_skip_deep_link_perms', {
            url,
            appId,
            udid: device.udid
        });
    ...
    (0, _events.event)('simctl_deep_link_perms', {
        url,
        appId,
        udid: device.udid
    });
    ...
    try {
        ...
        (0, _events.event)('simctl_url_scheme_parse_error', {
