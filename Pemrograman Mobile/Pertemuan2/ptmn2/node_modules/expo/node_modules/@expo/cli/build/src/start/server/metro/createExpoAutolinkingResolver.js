...
0 && (module.exports = {
    _dependenciesToRegex: null,
    createAutolinkingModuleResolver: null,
    createAutolinkingModuleResolverInput: null
});
...
const toPlatformModuleDescription = (dependencies, platform, supportPackage)=>{
    ...
    (0, _resolveEvents.event)('autolinking_registered', {
        platform,
        count: resolvedModuleNames.length
    });
    return {
        platform,
