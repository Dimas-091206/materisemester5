...
const _tunnelEvents = require("./tunnelEvents");
...
class AsyncNgrok {
    projectRoot;
    port;
    /** Resolves the best instance of ngrok, exposed for testing. */ resolver;
    /** Info about the currently running instance of ngrok. */ serverUrl = null;
    ...
    /** Start ngrok on the given port for the project. */ async startAsync({ timeout } = {}) {
        const done = _tunnelEvents.event.span();
        try {
            ...
            (0, _tunnelEvents.event)('failed', {
                provider: 'ngrok',
                error: _tunnelEvents.event.error(error)
            });
            throw error;
        }
        (0, _tunnelEvents.debugEvent)('url', {
            url: this.serverUrl
        });
    ...
    async _getConnectionPropsAsync() {
        ...
        if (userDefinedSubdomain) {
            ...
            (0, _tunnelEvents.debugEvent)('ngrok_subdomain', {
                subdomain
            });
            return {
                subdomain
            ...
            (0, _tunnelEvents.debugEvent)('ngrok_hostname', {
                hostname
            });
            return {
                hostname
    ...
    async connectToNgrokInternalAsync(instance, attempts = 0) {
        try {
            ...
            (0, _tunnelEvents.debugEvent)('ngrok_config_path', {
                path: configPath
            });
    ...
    async _resetProjectRandomnessAsync() {
        ...
        (0, _tunnelEvents.debugEvent)('ngrok_randomness_reset', {
            randomness
        });
        return randomness;
    }
