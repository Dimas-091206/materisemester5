...
0 && (module.exports = {
    createMetroEndpointAsync: null,
    evalMetroAndWrapFunctions: null,
    evalMetroNoHandling: null
});
...
_export(exports, {
    ...
    get evalMetroAndWrapFunctions () {
        return evalMetroAndWrapFunctions;
    },
    get evalMetroNoHandling () {
...
const _ssrEvents = require("./metro/ssrEvents");
...
function evalMetroNoHandling(projectRoot, src, filename, sourceMap) {
    ...
    if (!_fs().default.existsSync(_path().default.dirname(filename))) {
        (0, _ssrEvents.event)('eval_filename_not_in_dir', {
            filename: _ssrEvents.event.path(filename)
        });
    } else if (!(0, _filePath.toPosixPath)(_path().default.dirname(filename)).startsWith((0, _filePath.toPosixPath)(projectRoot))) {
        (0, _ssrEvents.event)('eval_filename_outside_root', {
            filename: _ssrEvents.event.path(filename)
        });
    }
