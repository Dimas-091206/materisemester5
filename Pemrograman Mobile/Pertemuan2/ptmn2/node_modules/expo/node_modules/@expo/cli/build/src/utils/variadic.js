...
0 && (module.exports = {
    assertUnexpectedObjectKeys: null,
    assertUnexpectedVariadicFlags: null,
    parseVariadicArguments: null
});
...
_export(exports, {
    get assertUnexpectedObjectKeys () {
        return assertUnexpectedObjectKeys;
    },
    get assertUnexpectedVariadicFlags () {
        return assertUnexpectedVariadicFlags;
    },
    get parseVariadicArguments () {
...
function parseVariadicArguments(argv, strFlags = []) {
    ...
    if (extraOperator > -1 && argv.length > extraOperator + 1) {
        ...
        (0, _events.event)('variadic_extras', {
            extras
        });
    }
    (0, _events.event)('variadic_parsed', {
        variadic,
        flags: parsedFlags,
        extras
    });
