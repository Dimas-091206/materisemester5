...
0 && (module.exports = {
    assetPatternsToBeBundled: null,
    exportAssetsAsync: null,
    resolveAssetPatternsToBeBundled: null
});
...
_export(exports, {
    get assetPatternsToBeBundled () {
        return assetPatternsToBeBundled;
    },
    get exportAssetsAsync () {
        return exportAssetsAsync;
    },
    get resolveAssetPatternsToBeBundled () {
 ...
 */ function setOfAssetsToBeBundled(assets, assetPatternsToBeBundled, projectRoot) {
    ...
    const allBundledAssets = assets.map((asset)=>{
        ...
        if (shouldBundle) {
            (0, _events.debugEvent)('assets:asset_filter', {
                file: asset.files?.[0] ?? '',
                include: true
            });
...
async function exportAssetsAsync(projectRoot, { exp, outputDir, bundles: { web, ...bundles }, baseUrl, files = new Map(), hostedNative }) {
    ...
    if (assets[0]?.fileHashes) {
        (0, _events.debugEvent)('assets:all', {
        ...
        if (bundledAssetsSet) {
            (0, _events.debugEvent)('assets:bundled', {
                bundledAssets: JSON.stringify([
                    ...bundledAssetsSet
                ], null, 2)
            });
            ...
            (0, _events.debugEvent)('assets:filtered_count', {
