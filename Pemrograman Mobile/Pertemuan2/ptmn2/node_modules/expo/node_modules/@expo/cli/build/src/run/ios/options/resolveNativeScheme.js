...
0 && (module.exports = {
    getDefaultNativeScheme: null,
    promptOrQueryNativeSchemeAsync: null,
    resolveNativeSchemePropsAsync: null
});
...
_export(exports, {
    get getDefaultNativeScheme () {
        return getDefaultNativeScheme;
    },
    get promptOrQueryNativeSchemeAsync () {
        return promptOrQueryNativeSchemeAsync;
    },
    get resolveNativeSchemePropsAsync () {
...
function getDefaultNativeScheme(projectRoot, options, xcodeProject) {
    ...
    if (resolvedSchemes.length > 1) {
        ...
        (0, _events.debugEvent)('ios:default_scheme', {
            name: scheme.name
        });
        return scheme;
    }
