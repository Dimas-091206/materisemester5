...
0 && (module.exports = {
    _loadTsConfigWithExtends: null,
    _resolveWithTsConfigPaths: null,
    _toResolveConfig: null,
    createTypescriptResolver: null
});
...
function loadTsConfigPaths(projectRoot, depGraph) {
    ...
    try {
        ...
        if (error?.isJsonFileError || error?.name === 'SyntaxError') {
            (0, _resolveEvents.event)('tsconfig_parse_failed', {
                path: configPath,
                error: error.message
            });
            return null;
