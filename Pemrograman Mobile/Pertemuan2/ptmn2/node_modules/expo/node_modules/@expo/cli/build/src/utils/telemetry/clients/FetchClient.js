...
class FetchClient {
    ...
    /** The fetch instance used to transport telemetry to the backend */ fetch;
    /** The endpoint to send events to */ url;
    /** Additional headers to send with every event */ headers;
