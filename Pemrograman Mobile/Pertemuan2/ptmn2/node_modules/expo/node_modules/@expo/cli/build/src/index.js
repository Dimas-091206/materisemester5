...
if ((0, _getenv().boolish)('EXPO_DEBUG', false) || /(^|[,\s])expo(:|\*|$)/.test(process.env.DEBUG ?? '')) {
...
(0, _2g().installEventLogger)({
    command: args['--version'] ? 'expo --version' : args['--help'] && !isSubcommand ? 'expo --help' : `expo ${command}`,
    version: "58.0.0"
});
if (args['--version']) {
