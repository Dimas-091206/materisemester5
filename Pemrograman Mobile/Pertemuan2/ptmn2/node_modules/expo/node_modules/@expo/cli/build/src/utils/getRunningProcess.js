...
0 && (module.exports = {
    getDirectoryOfProcessById: null,
    getPID: null,
...
async function getPID(port) {
    try {
        ...
        (0, _events.event)('port_pid_failed', {
            port,
...
async function getDirectoryOfProcessById(pid) {
    try {
        ...
        const processCWD = stdout.split('\n').find((output)=>output.startsWith('n'))?.slice(1);
