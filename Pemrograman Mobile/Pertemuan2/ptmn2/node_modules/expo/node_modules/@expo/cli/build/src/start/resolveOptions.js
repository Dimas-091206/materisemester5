...
0 && (module.exports = {
    resolveHostType: null,
    resolveOptionsAsync: null,
    resolvePortsAsync: null,
    resolveSchemeAsync: null
});
...
_export(exports, {
    ...
    get resolvePortsAsync () {
        return resolvePortsAsync;
    },
    get resolveSchemeAsync () {
...
async function resolvePortsAsync(projectRoot, options, bundlers) {
    const metroPort = await (0, _port.resolveMetroPortAsync)(projectRoot, {
    ...
    if (bundlers.includes('webpack')) {
        const webpackPort = await (0, _port.choosePortAsync)(projectRoot, {
