...
async function getUserAsync() {
    const hasCredentials = (0, _UserSettings.getAccessToken)() || (0, _UserSettings.getSession)()?.sessionSecret;
...
async function logoutAsync() {
    const sessionSecret = (0, _UserSettings.getSession)()?.sessionSecret;
    if (sessionSecret) {
        try {
            ...
            (0, _events.debugEvent)('logout_server_failed', {
