...
import { type BabelSourceMapSegment, type EncodedTransformerSourceMap } from '../serializer/sourceMap';
...
export declare const minifyCode: (config: Pick<JsTransformerConfig, "minifierPath" | "minifierConfig">, filename: string, code: string, source: string, rawMappings: readonly BabelSourceMapSegment[], reserved?: string[], inputSourceMap?: EncodedTransformerSourceMap) => Promise<{
    code: string;
