...
/** Exposed for debugging */ export function _appendNewLog(newLog) {
...
export function withSubscription(WrappedComponent) {
    class RootDevErrorBoundary extends React.Component {
        ...
        componentDidCatch(err, errorInfo) {
            ...
            const { category, message, componentStack } = parseLogBoxLog([
                err
            ]);
        ...
        render() {
            return /*#__PURE__*/ _jsxs(LogContext.Provider, {
                value: {
