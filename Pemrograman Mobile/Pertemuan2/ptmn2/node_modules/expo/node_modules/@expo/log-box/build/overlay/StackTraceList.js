...
import { getStackFormattedLocation, isStackFileAnonymous, openFileInEditor } from '../utils/devServerEndpoints';
...
function List({ items, showCollapsed, isInitial, initialDelay }) {
    const [displayItems, setDisplayItems] = React.useState(items.filter((item)=>!item.isCollapsed).map((item)=>({
            item,
            status: 'stable'
        })));
    React.useEffect(()=>{
    ...
    return /*#__PURE__*/ _jsx("div", {
        children: displayItems.map((d, index)=>/*#__PURE__*/ _jsx(Transition, {
                status: d.status,
...
export function StackTraceList({ onRetry, type, stack, symbolicationStatus }) {
    const [collapsed, setCollapsed] = useState(true);
    const stackCount = stack?.length;
    const [isInitial, setIsInitial] = React.useState(true);
    const initialDelay = 50;
    const initialTimer = React.useRef(null);
    React.useEffect(()=>{
        if (isInitial) {
    ...
    const stackTraceItems = stack.map((frame, index)=>{
        ...
        const isLaunchable = !isStackFileAnonymous(frame) && symbolicationStatus === 'COMPLETE' && file != null && lineNumber != null;
        const isCollapsed = type === 'component' && process.env.EXPO_DOM_HOST_OS !== 'web' ? index >= expandFirst : !!frame.collapse;
        return {
            id: index,
            content: /*#__PURE__*/ _jsx(StackTraceItem, {
    ...
    return /*#__PURE__*/ _jsxs("div", {
        ...
        children: [
            /*#__PURE__*/ _jsxs("div", {
                ...
                children: [
                    /*#__PURE__*/ _jsxs("div", {
                        ...
                        children: [
                            type === 'component' ? /*#__PURE__*/ _jsx(ReactIcon, {
                                stroke: "unset",
                                className: styles.headerIcon
                            }) : /*#__PURE__*/ _jsx(JavaScriptIcon, {
                                className: styles.headerIcon
                            }),
                            /*#__PURE__*/ _jsx("h3", {
                            ...
                            /*#__PURE__*/ _jsx(LogBoxInspectorSourceMapStatus, {
                        ...
                        children: /*#__PURE__*/ _jsxs("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ _jsx("svg", {
                                    ...
                                    children: collapsed ? /*#__PURE__*/ _jsxs(_Fragment, {
                                        children: [
                                            /*#__PURE__*/ _jsx("path", {
                                                d: "m7 15 5 5 5-5"
                                            }),
            ...
            symbolicationStatus !== 'COMPLETE' && /*#__PURE__*/ _jsx("div", {
...
function StackTraceItem({ frame, onPress, isLaunchable }) {
    ...
    return /*#__PURE__*/ _jsxs("div", {
        ...
        children: [
            /*#__PURE__*/ _jsx("code", {
                className: styles.stackFrameTitle,
                children: frame.methodName
            }),
            /*#__PURE__*/ _jsx("code", {
                className: styles.stackFrameFile,
                children: fileName
            })
        ]
    });
}
const ReactIcon = (props)=>/*#__PURE__*/ _jsx("svg", {
        xmlns: "http://www.w3.org/2000/svg",
        viewBox: "0 0 24 24",
        fill: "currentColor",
        ...props,
...
const JavaScriptIcon = (props)=>/*#__PURE__*/ _jsx("svg", {
        xmlns: "http://www.w3.org/2000/svg",
        viewBox: "0 0 24 24",
        fill: "currentColor",
        ...props,
...
//# sourceMappingURL=StackTraceList.js.map
