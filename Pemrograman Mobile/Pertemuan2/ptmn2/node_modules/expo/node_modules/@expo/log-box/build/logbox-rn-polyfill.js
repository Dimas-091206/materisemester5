...
function LogBoxRNPolyfill(props) {
    ...
    const LogBoxWrapper = useMemo(()=>Platform.OS === 'ios' ? ({ children, open })=>{
    ...
    return(// `LogBoxWrapper` is memoized with empty dependencies, so its identity is stable
    // across renders.
    // oxlint-disable-next-line react/static-components
    /*#__PURE__*/ _jsx(LogBoxWrapper, {
        open: open,
        children: /*#__PURE__*/ _jsx(View, {
            ...
            collapsable: false,
            children: /*#__PURE__*/ _jsx(LogBoxPolyfillDOM, {
...
function LogBoxInspectorContainer({ selectedLogIndex, logs }) {
    ...
    return /*#__PURE__*/ _jsx(LogBoxRNPolyfill, {
