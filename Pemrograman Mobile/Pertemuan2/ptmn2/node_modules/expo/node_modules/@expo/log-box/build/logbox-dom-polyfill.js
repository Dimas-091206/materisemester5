...
export default function LogBoxPolyfillDOM({ // Default is mainly used in RedBox replacement,
...
onCopyText = (text)=>navigator.clipboard.writeText(text), onMinimize, fetchTextAsync, onReload, ...props }) {
    ...
    useNativeLogBoxDataPolyfill({
        logs
    }, props);
    return /*#__PURE__*/ _jsx(LogContext, {
        value: {
            selectedLogIndex: selectedIndex,
            isDisabled: false,
            logs
        },
        children: /*#__PURE__*/ _jsx(ActionsContext, {
            onMinimize: onMinimize,
            onReload: onReload,
            onCopyText: onCopyText,
            children: /*#__PURE__*/ _jsx(LogBoxInspectorContainer, {})
        })
    });
}
