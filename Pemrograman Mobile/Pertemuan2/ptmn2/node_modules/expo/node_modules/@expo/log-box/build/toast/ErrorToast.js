...
export function ErrorToastContainer() {
    ...
    return /*#__PURE__*/ _jsx(ErrorToastStack, {
        logs: logs
    });
}
function ErrorToastStack({ logs }) {
    ...
    const errors = useMemo(()=>logs.filter((log)=>log.level === 'error' || log.level === 'fatal'), [
        logs
    ]);
    const lastError = errors[errors.length - 1];
    return /*#__PURE__*/ _jsx("div", {
        className: styles.container,
        children: lastError != null && /*#__PURE__*/ _jsx(ErrorToast, {
            log: lastError,
            level: "error",
    ...
    return /*#__PURE__*/ _jsxs("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ _jsx("span", {
                ...
                children: log.message && /*#__PURE__*/ _jsx(LogBoxMessage, {
                    maxLength: 40,
                    message: log.message
                })
            }),
            /*#__PURE__*/ _jsx(Dismiss, {
...
function Dismiss({ onPress }) {
    return /*#__PURE__*/ _jsx("button", {
        ...
        children: /*#__PURE__*/ _jsx("div", {
            className: styles.dismissContent,
