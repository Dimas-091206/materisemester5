...
Object.defineProperty(exports, "expoRouterBabelPlugin", {
    enumerable: true,
    get: function() {
 ...
 */ function getExpoRouterAppRoot(currentFile, appFolder) {
    const appRoot = _nodepath().default.relative(_nodepath().default.dirname(currentFile), appFolder);
...
function expoRouterBabelPlugin(api) {
    ...
    const asyncRoutes = api.caller(_common.getAsyncRoutes);
    const routerAbsoluteRoot = api.caller(_common.getExpoRouterAbsoluteAppRoot);
