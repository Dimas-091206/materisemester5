...
Object.defineProperty(exports, "serverDataLoadersPlugin", {
    enumerable: true,
    get: function() {
        return serverDataLoadersPlugin;
    }
});
...
function serverDataLoadersPlugin(api) {
    ...
    const isLoaderBundle = api.caller(_common.getIsLoaderBundle);
    return {
 ...
 */ function isInAppDirectory(filePath, routerRoot) {
    const normalizedFilePath = (0, _common.toPosixPath)(filePath);
    const normalizedAppRoot = (0, _common.toPosixPath)(routerRoot);
