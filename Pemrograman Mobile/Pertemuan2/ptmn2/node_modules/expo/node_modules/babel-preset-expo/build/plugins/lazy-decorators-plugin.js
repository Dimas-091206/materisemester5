...
0 && (module.exports = {
    _lazyDecoratorsPlugin: null,
    lazyDecoratorsPlugins: null
});
...
_export(exports, {
    get _lazyDecoratorsPlugin () {
        return _lazyDecoratorsPlugin;
    },
    get lazyDecoratorsPlugins () {
        return lazyDecoratorsPlugins;
    }
});
...
function lazyDecoratorsPlugins(options) {
    ...
    const plugins = [
        [
            _lazyDecoratorsPlugin,
            options.presetOptions ?? {
                legacy: true
            }
        ]
    ];
    if (options.transformClassProperties) plugins.push([
        lazyClassPropertiesPlugin,
        {
            loose: true
        }
    ]);
    if (options.transformPrivateMethods) plugins.push([
        lazyPrivateMethodsPlugin,
        {
            loose: true
        }
    ]);
    if (options.transformPrivateProperties) plugins.push([
