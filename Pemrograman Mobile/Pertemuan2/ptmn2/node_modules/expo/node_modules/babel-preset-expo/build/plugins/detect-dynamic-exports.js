...
Object.defineProperty(exports, "detectDynamicExports", {
    enumerable: true,
    get: function() {
        return detectDynamicExports;
    }
});
        ...
        visitor: {
            ...
            CallExpression (path, state) {
                ...
                path.node.arguments.length > 1) {
                    const isModuleExports = t.isMemberExpression(path.node.arguments[0]) && t.isIdentifier(path.node.arguments[0].object, {
                        name: 'module'
                    }) && // Second argument is `exports` or 'exports'
                    // .exports
                    (t.isIdentifier(path.node.arguments[0].property, {
                        name: 'exports'
                    }) || // ['exports']
                    t.isStringLiteral(path.node.arguments[0].property) && path.node.arguments[0].property.value === 'exports');
            ...
            AssignmentExpression (path, state) {
                ...
                if (t.isMemberExpression(left) && (t.isIdentifier(left.object, {
                    ...
                    name: 'exports'
                }) || t.isStringLiteral(left.property) && left.property.value === 'exports') || t.isIdentifier(left.object, {
                    name: 'exports'
                })) || 'object' in left && t.isMemberExpression(left.object) && t.isIdentifier(left.object.object, {
                    name: 'module'
                    ...
                    name: 'exports'
                }) && path.scope.hasGlobal('exports') && // Ensure left is not defined in any scope
