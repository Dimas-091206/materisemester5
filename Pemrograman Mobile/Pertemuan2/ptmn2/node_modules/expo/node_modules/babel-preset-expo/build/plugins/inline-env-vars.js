...
Object.defineProperty(exports, "expoInlineEnvVars", {
    enumerable: true,
    get: function() {
        return expoInlineEnvVars;
    }
});
...
function expoInlineEnvVars(api) {
    ...
    function isProcessEnv(path) {
        ...
        if (!t.isMemberExpression(object) || !t.isIdentifier(object.object) || object.object.name !== 'process') {
            return false;
        }
    ...
    /** If the `path.node` being assigned to (`left = right`) */ function isAssignment(path) {
