...
export function isReactNativeBlobGlobal() {
    try {
 ...
 */ export async function createReactNativeBlobAsync(buffer, type) {
    const BlobManager = require('react-native/Libraries/Blob/BlobManager').default;
    const blobId = await ExpoFetchModule.unstable_createBlobData(new Uint8Array(buffer));
